...
export default function ExpenseTrackerComponent() {
  ...
  return (
    <div className="flex flex-col h-screen">
      {/* Header section */}
      <header className="bg-cyan-600 text-primary-foreground py-4 px-6 shadow">
      ...
      {/* Main section */}
      <main className="flex-1 overflow-y-auto p-6 text-cyan-700">
          ...
          {expenses.map((expense) => (
            ...
            >
              <div>
                ...
                <p className="text-muted-foreground text-cyan-950">
      ...
      <div className="fixed bottom-6 right-6">
        <Button
          size="icon"
          className="rounded-full shadow-lg bg-cyan-600"
          onClick={() => {
            setShowModal(true);
            setIsEditing(false);
            resetForm();
